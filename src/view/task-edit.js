...
/**
 * создает шаблон блока дедлайна
 * @param {object} dueDate - дата и время дедлайна задачи, либо null при его отсутствии
 * @param {Boolean} isDueDate - флаг, указывающий есть дедлайн для задачи или нет
...
/**
 * создает шаблон блока с выбором дня повторения задачи
 * @param {object} repeating - объект календарной недели с днями в которых повторяется задача
 * @param {Boolean} isRepeating - флаг, указывающий на наличие повторений задачи
 * @return {string} возвращает HTML-строку в ввиде кода HTML
 */
...
/**
 * создает шаблон блока с выбором цвета карточки задачи
 * @param {string} currentColor - строка со значением цвета карточки задачи
 * @return {string} возвращает HTML-строку в ввиде кода HTML
 */
...
/**
 * создает шаблон карточки редактирования задачи
 * @param {object} data - объект с описанием задачи
 * @return {string} возвращает HTML-строку в ввиде кода HTML
 */
